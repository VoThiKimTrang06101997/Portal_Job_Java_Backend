...
// 	@GetMapping("")
// 	public ResponseEntity<?> getAll(@RequestParam(defaultValue = PageDefault.NO) int no, @RequestParam(defaultValue = PageDefault.LIMIT) int limit) {
...
// 		return new ResponseEntity<>(this.majorService.create(majorDTO), HttpStatus.CREATED);
// 	}

// 	@SecurityRequirement(name = "Bearer Authentication")
// 	@PreAuthorize("hasAuthority('Role_Admin')")
// 	@PutMapping("/{id}")
// 	public ResponseEntity<?> update(@PathVariable int id, @RequestBody MajorDTO majorDTO) {
