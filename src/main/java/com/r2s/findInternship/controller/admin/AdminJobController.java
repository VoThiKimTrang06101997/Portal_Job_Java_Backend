package com.r2s.findInternship.controller.admin;
...
//     @GetMapping("")
//     public ResponseEntity<?> findAllActive(@RequestParam(defaultValue = PageDefault.NO) int no, @RequestParam(defaultValue = PageDefault.LIMIT) int limit) {
//         return ResponseEntity.ok(jobService.findAllActive(no, limit));
//     }

//     @GetMapping("/user/{id}")
//     public ResponseEntity<?> findAllActiveByUserId(@PathVariable("id") long userId, @RequestParam(defaultValue = PageDefault.NO) int no,
//             @RequestParam(defaultValue = PageDefault.LIMIT) int limit) {
//         return ResponseEntity.ok(this.jobService.findAllActiveByUserId(userId, no, limit));
//     }

//     @GetMapping("/hr/{id}")
//     public ResponseEntity<?> findAllActiveByHrId(@PathVariable("id") int hrId, @RequestParam(defaultValue = PageDefault.NO) int no,
//             @RequestParam(defaultValue = PageDefault.LIMIT) int limit) {
//         return ResponseEntity.ok(this.jobService.findAllActiveByHrId(hrId, no, limit));
//     }
...
//     public ResponseEntity<?> findAllActiveByUsername(@PathVariable String username, @RequestParam(defaultValue = PageDefault.NO) int no,
//             @RequestParam(defaultValue = PageDefault.LIMIT) int limit) {
...
//         // return new ResponseEntity<>(this.jobService.create(jobDTO), HttpStatus.CREATED);
//         return null;
//     }

//     @PutMapping("/{id}")
//     public ResponseEntity<?> update(@PathVariable int id, @RequestBody JobDTO jobDTO) {
//         // LocationDTO locationDTO = jobDTO.getLocationDTO();
...
//     public ResponseEntity<?> findAllActiveByCompanyId(@PathVariable int id, @RequestParam(defaultValue = PageDefault.NO) int no,
//             @RequestParam(defaultValue = PageDefault.LIMIT) int limit) {
//         return ResponseEntity.ok(this.jobService.findAllActiveByCompanyIdShowForHr(id, no, limit));
//     }
