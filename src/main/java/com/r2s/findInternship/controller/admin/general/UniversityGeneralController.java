...
// 			@RequestParam(defaultValue = PageDefault.LIMIT) int limit) {
// 		return ResponseEntity.ok(this.universityService.findAllByNameLike(name, no, limit));
// 	}

// 	@GetMapping("/{shortname}")
// 	public ResponseEntity<?> findAllByShortNameLike(@PathVariable String shortName,
// 			@RequestParam(defaultValue = PageDefault.NO) int no,
// 			@RequestParam(defaultValue = PageDefault.LIMIT) int limit) {
// 		return ResponseEntity.ok(this.universityService.findAllByShortNameLike(shortName, no, limit));
// 	}

// 	@GetMapping("/province/{id}")
// 	public ResponseEntity<?> findAllByProvinceId(@PathVariable("id") int provinceId,
// 			@RequestParam(defaultValue = PageDefault.NO) int no,
// 			@RequestParam(defaultValue = PageDefault.LIMIT) int limit) {
// 		return ResponseEntity.ok(this.universityService.findAllByProvinceId(provinceId, no, limit));
// 	}
