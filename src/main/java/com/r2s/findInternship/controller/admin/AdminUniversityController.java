...
// 	public ResponseEntity<?> create(@RequestPart("university") String universityJson,
// 			@RequestPart(name = "logo", required = false) MultipartFile file) {
// 		UniversityCreationDTO dto = this.universityService.readJson(universityJson, "", null, file);
// 		return new ResponseEntity<UniversityDTO>(this.universityService.create(dto), HttpStatus.CREATED);
// 	}
...
// 		UniversityCreationDTO universityDTO = this.universityService.readJson(universityJson, "", null, file);
...
// 	public ResponseEntity<?> getUniversityByNameAndPaging(@PathVariable String name,
// 			@RequestParam(required = false) Map<String, String> params) {
// 		int no = Integer.parseInt(params.getOrDefault("no", "0"));
// 		int limit = Integer.parseInt(params.getOrDefault("limit", "20"));
// 		return ResponseEntity.ok(universityService.findAllByNameLike(name, no, limit));
// 	}

// 	@PutMapping("/status/{id}")
// 	public ResponseEntity<?> changeStatus(@RequestBody UniversityDTO universityDTO, @PathVariable int id) {
// 		return ResponseEntity.ok(this.universityService.changeStatus(id, universityDTO));
// 	}
// }
