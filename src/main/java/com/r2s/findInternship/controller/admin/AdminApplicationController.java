...
// 	public ResponseEntity<?> create(@RequestPart("application") String applicationJson,
// 			@RequestPart(name = "fileCV", required = false) MultipartFile fileCV) {
// 		CandidateApplicationDTO applicationDTO = applicationService.readJson(applicationJson, fileCV);
// 		return new ResponseEntity<>(this.applicationService.create(applicationDTO), HttpStatus.CREATED);
// 	}
...
// 			@RequestParam(defaultValue = PageDefault.LIMIT) int limit) {
// 		return ResponseEntity.ok(this.applicationService.findAllByJobId(id, no, limit));
// 	}
...
// 			@RequestParam(defaultValue = PageDefault.LIMIT) int limit) {
// 		return ResponseEntity.ok(this.applicationService.findAllByCandidateId(id, no, limit));
// 	}
...
// 			@RequestParam(defaultValue = PageDefault.NO) int no,
// 			@RequestParam(defaultValue = PageDefault.LIMIT) int limit) {
// 		return ResponseEntity.ok(this.applicationService.findAllByUsername(username, no, limit));
// 	}

// 	@PutMapping("/{id}")
// 	public ResponseEntity<?> update(@PathVariable int id, @RequestBody CandidateApplicationDTO applicationDTO) {
