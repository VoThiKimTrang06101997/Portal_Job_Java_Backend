...
// 		return ResponseEntity.ok(this.userMapper.toDetailsDTO(userService.findByUsername(username)));
// 	}
...
// 	public ResponseEntity<?> create(@RequestPart(value = "candidate", required = false) String candidateJson,
...
// 		// 	CandidateCreationDTO candidateCreateDTO = candidateService.readJson(candidateJson, fileCV, fileAvatar);
// 		// 	return new ResponseEntity<CandidateDTO>(candidateService.create(candidateCreateDTO), HttpStatus.CREATED);
// 		// }

// 		// if (partnerJson != null) {
// 		// 	UniversityCreationDTO universityCreateDTO = universityService.readJson(universityJson, partnerJson,
// 		// 			fileAvatar, fileLogo);

// 		// 	return new ResponseEntity<UniversityDTO>(this.universityService.createFirst(universityCreateDTO),
// 		// 			HttpStatus.CREATED);
// 		// }

// 		// if (hrJson != null) {
// 		// 	HRDTO hrDTO = hrService.readJson(hrJson, fileAvatar);
// 		// 	return new ResponseEntity<HRDTO>(hrMapper.toDTO(hrMapper.toEntity(hrService.create(hrDTO))),
// 		// 			HttpStatus.CREATED);
// 		// }
// 		// Map<String, String> response = new HashMap<>();
// 		// response.put("status", "400");
// 		// response.put("message", messageSource.getMessage("error.missingvalue", null, null));
// 		// return ResponseEntity.status(HttpStatus.BAD_REQUEST).body(response);
// 		return null;
// 	}

// 	@PutMapping(value = "", consumes = { MediaType.APPLICATION_JSON_VALUE, MediaType.MULTIPART_FORM_DATA_VALUE })
// 	public ResponseEntity<?> update(@RequestPart(value = "candidate", required = false) String candidateJson,
// 			@RequestPart(value = "fileCV", required = false) MultipartFile fileCV,
// 			@RequestPart(value = "fileAvatar", required = false) MultipartFile fileAvatar,
// 			@RequestPart(value = "partner", required = false) String partnerJson,
// 			@RequestPart(value = "university", required = false) String universityJson,
...
// 		// }
// 		// if (partnerJson != null) {
// 		// 	PartnerCreationDTO partnerCreateDTO = partnerService.readJson(partnerJson);
