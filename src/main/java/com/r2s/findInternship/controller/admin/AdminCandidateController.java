...
// 	@GetMapping("/job/{id}")
// 	public ResponseEntity<?> findByJobId(@PathVariable("id") int jobId, @RequestParam(defaultValue = PageDefault.NO) int no,
// 			@RequestParam(defaultValue = PageDefault.LIMIT) int limit) {
// 		return ResponseEntity.ok(this.candidateService.findByJobId(jobId, no, limit));
// 	}
...
// 			@RequestParam(defaultValue = PageDefault.LIMIT) int limit) {
// 		return ResponseEntity.ok(this.candidateService.findAllByMajorId(majorId, no, limit));
// 	}
