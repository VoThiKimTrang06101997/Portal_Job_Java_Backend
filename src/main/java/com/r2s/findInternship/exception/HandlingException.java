...
public class HandlingException {
	...
	public MessageResponse handlerNotFound(ResourceNotFoundException ex, HttpServletRequest request) {
	...
	public ResponseEntity<?> invalidException(IllegalArgumentException ex, HttpServletRequest request) {
	...
	@ResponseStatus(value = HttpStatus.BAD_REQUEST)
	public MessageResponse handlerExceptionCustom(CustomException ex, HttpServletRequest request) {
	...
	@ResponseStatus(value = HttpStatus.BAD_REQUEST)
	public MessageResponse handlerInvalidOldPassword(InvalidOldPasswordException ex, HttpServletRequest request) {
		logger.warn(ex.toString());
...
//	@ExceptionHandler(value = Exception.class)
//	@ResponseStatus(value = HttpStatus.BAD_REQUEST)
//	public MessageResponse handlerNotFound(Exception ex, HttpServletRequest request) {
//		logger.error("Please check!");
//		return new MessageResponse(500, ex.getMessage(), request.getServletPath());
//	}
